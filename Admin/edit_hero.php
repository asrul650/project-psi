                ...
                <div class="form-container">
                    ...
                    <form action="edit_hero.php?id=<?php echo $hero_id; ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select id="counter_hero_ids" name="counter_hero_ids[]" multiple size="6" style="width:100%;" onchange="showCounterDescriptions()">
                            ...
                            <small>Pilih hero yang menjadi counter untuk hero ini (bisa lebih dari satu).</small>
                            <div id="counter-descriptions-box">
                                <?php foreach ($all_heroes as $h): ?>
                                    <div class="counter-desc-row" id="desc-row-<?php echo $h['id']; ?>" style="display:<?php echo array_key_exists($h['id'], $selected_counters) ? 'block' : 'none'; ?>;margin-top:8px;">
                                        <label for="counter_desc_<?php echo $h['id']; ?>">Alasan <?php echo htmlspecialchars($h['name']); ?> menjadi counter:</label>
                                        <textarea name="counter_descriptions[<?php echo $h['id']; ?>]" id="counter_desc_<?php echo $h['id']; ?>" rows="2" style="width:100%;"><?php echo isset($selected_counters[$h['id']]) ? htmlspecialchars($selected_counters[$h['id']]) : ''; ?></textarea>
                                    </div>
                                <?php endforeach; ?>
                            </div>
                        </div>
